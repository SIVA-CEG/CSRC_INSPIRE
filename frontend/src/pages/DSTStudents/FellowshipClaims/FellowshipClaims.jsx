  ...
  return (
    <div className="claims-page">
      ...
      <div className="claims-header">
        ...
        <div>
          <h1>Fellowship Claims</h1>
          <p>
            Manage monthly fellowship salary claims
          </p>
        </div>
