...
import "./ArrearClaims.css";

import ArrearPreview from "./ArrearPreview";
import ArrearWizard from "./ArrearWizard";


export default function ArrearClaims() {
    ...
    <div className="claims-page">
      ...
      <div className="claims-header">
        ...
        <div>
          <h1>arrear Claims</h1>
          <p>
            Manage monthly arrear salary claims
          </p>
        </div>
