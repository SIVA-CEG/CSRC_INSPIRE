...
import "./HRAPDFTemplate.css";

export default function HRAPDFTemplate({
  claim,
  currentPage
}) {
        ...
        <table className="pdf-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>:</td>
              <td>
                ₹{claim.hraAmount?.toLocaleString()}
              </td>
            </tr>
