...
const calcOverhead = (totalOverhead) => {
  ...
  const head4 = oh * (4 / 15);
  const csrc5 = oh * (5 / 15);
  return { reg6, head4, csrc5, total: oh };
};
  ...
  <table>
    ...
    <td class="sl-col"><B>A</B></td>
      ...
      <tr>
        ...
        html<tr><td>i</td><td class="indent">Registrar A/c (6%)</td><td>${fmtINR(t.reg6)}</td></tr>
        <td class="amount-col">${fmtINR(t.reg5)}</td>
      </tr>

      <tr>
        <td class="sl-col">6</td>
        <tr><td>ii</td><td class="indent">The Professor and Head, CIS A/c (4%)</td><td>${fmtINR(t.head4)}</td></tr>
        <td class="amount-col">${fmtINR(t.dean4)}</td>
      </tr>

      <tr>
        <td class="sl-col">7</td>
        <tr><td>iii</td><td class="indent">CSRC Revenue A/c (5%)</td><td>${fmtINR(t.csrc5)}</td></tr>
  ...
  <tr key={row.key}>
    ...
    <td>
      ...
      />
                    ...
                    {[
                      { label: 'Registrar A/c',               pct: '6%', val: t.reg6  },
{ label: 'Professor and Head, CIS A/c', pct: '4%', val: t.head4 },
{ label: 'CSRC Revenue A/c',            pct: '5%', val: t.csrc5 },

                    ].map((row, ri) => (
                      <tr key={ri} className="sl-oh-split-row">
                        <td className="sl-sl-cell sl-roman">{['i','ii','iii'][ri]}</td>
